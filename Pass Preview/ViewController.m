...
@interface ViewController () <UITableViewDelegate, UITableViewDataSource, PKAddPassesViewControllerDelegate>{
...
- (void)viewDidLoad
{
    ...
    if (![PKPassLibrary isPassLibraryAvailable]) {
        ...
        [[[UIAlertView alloc] initWithTitle:@"Error" message:@"PassKit not available" delegate:self cancelButtonTitle:@"Okay" otherButtonTitles: nil] show];
        return;
    }
